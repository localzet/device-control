...
exports.apkSignedBuildPath = path.join(__dirname, '../assets/webpublic/device-control.apk')
...
exports.apkTool = path.join(__dirname, '../app/', 'apktool.jar');
exports.apkSign = path.join(__dirname, '../app/', 'sign.jar');
exports.smaliPath = path.join(__dirname, '../app');
exports.patchFilePath = path.join(exports.smaliPath, '/smali/com/localzet/devicecontrol/IOSocket.smali');
